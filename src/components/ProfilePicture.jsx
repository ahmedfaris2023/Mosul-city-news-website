  ...
  return (
   ...
   {openCrop && createPortal(<CropEasy photo={photo}  setOpenCrop={setOpenCrop}/>, document.getElementById('portal'))}
     ...
     <div className='w-full flex items-center gap-x-4'>
        ...
        <input type='file' className='sr-only' id='profilePicture' onChange={handleFileChange}></input>
       
        </div>
             <button 
             onClick={handleDeleteImage}
             type='button'
            className=' font-sans border border-red-500 rounded-lg px-4 py-2 text-red-500' >
                حذف
            </button>
    </div>
   </>
