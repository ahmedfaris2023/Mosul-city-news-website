  ...
  const { mutate: mutateCreatePost, isLoading: isLoadingCreatePost } =
    useMutation({
      ...
      onSuccess: (data) => {
        ...
        toast.success("تم إنشاء المنشور، قم بتحريره الآن!");
      ...
      {isMenuActive && (
        <div className="fixed inset-0 lg:static lg:h-full lg:w-full">
          ...
          <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
            ...
            <h4 className="font-sans  mt-10 font-bold text-[#C7C7C7]">القائمة الرئيسية</h4>
            {/* menu items */}
            <div className="mt-6 flex flex-col gap-y-[0.563rem]">
             <NavItem
              ...
              <NavItemCollapse
                ...
                setActiveNavName={setActiveNavName}
              >
                <Link to="/admin/posts/manage" className="font-sans">ادارة جميع المقالات</Link>
              <button
                  disabled={isLoadingCreatePost}
                  className="font-sans text-start disabled:opacity-60 disabled:cursor-not-allowed"
                  onClick={() =>
                ...
                <Link to="/admin/categories/manage">التصنيفات</Link>
              </NavItemCollapse>
                  <NavItem
                title="المستخدمين"
