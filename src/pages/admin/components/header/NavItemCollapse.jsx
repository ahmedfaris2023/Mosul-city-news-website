...
const NavItemCollapse = ({
  ...
  return (
    <div className="d-collapse d-collapse-arrow bg-base-200 min-h-0 rounded-none py-2">
      ...
      />
      <div
       className={`d-collapse-title  font-sans font-medium min-h-0 py-0 pl-0 flex items-center gap-x-2 text-lg ${name === activeNavName
             ? "font-bold font-sans text-primary"
