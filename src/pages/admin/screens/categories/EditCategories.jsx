...
const EditCategories = () => {
  ...
  return (
    <div className="col-span-4 py-8">
      <h4 className="text-lg leading-tight font-sans">تحديث التصنيف </h4>
      <div className="d-form-control w-full mt-6">
        ...
        <button
          ...
          className="w-fit mt-3 bg-green-500 text-white font-semibold rounded-lg px-4 py-2 disabled:cursor-not-allowed disabled:opacity-70 font-sans"
        >
          تحديث التصنيف 
        </button>
      </div>
