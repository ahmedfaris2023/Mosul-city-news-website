    ...
    <div className="fixed z-[1000] inset-0 bg-black/50 flex justify-center p-5 overflow-auto">
      <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
        ...
        <div>
          <label
            htmlFor="zoomRage"
            className="black mt-2 mb-0.5 text-sm font-medium text-gray-900"
          >
        ...
        <div className="flex justify-between gap-2 flex-wrap">
            <button disabled={isLoading} onClick={()=>setOpenCrop(false)} className="px-5 py-2.5 rounded-lg text-red-500 border border-red-500 text-sm disabled:opacity-70">
             ...
             <button disabled={isLoading} onClick={handleCropImage} className="px-5 py-2.5 rounded-lg text-white border bg-blue-500 text-sm disabled:opacity-70">
                Crop & Upload
            </button>
        </div>
      </div>
